                ...
                <div className="information">
                    ...
                    {product.price && (
                        <div className="information__pricing">
                            <div>
                                <span className="information__label">M.R.P. : </span><span className="strikethrough">{product.price.currency} {product.price.value}</span>
                            </div>
                            <div>
                                <span className="information__label">Price. :  </span>{product.price.currency} {+(product.price.value) - (product.price.discount)}
                            </div>
                            <div>
                                <span className="information__label">You Save : </span>{product.price.discount}
                            </div>
                        </div>
                    )}
                    ...
                    <div className="information__features">
                        <div className="information__spec_header">
                            About this item
                        </div>
                        <ul>
